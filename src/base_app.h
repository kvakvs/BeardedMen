...
public:
    ...
    void addMesh(const MeshType& surfaceMesh,
                 const pv::Vector3DInt32& translation = pv::Vector3DInt32(0, 0, 0),
                 float scale = 1.0f)
	{
        ...
        glBufferData(GL_ARRAY_BUFFER,
                     surfaceMesh.getNoOfVertices() * sizeof(typename MeshType::VertexType),
        ...
        glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE,
                              ...
                              (GLvoid*)(offsetof(typename MeshType::VertexType, position))); //take the first 3 floats from every sizeof(decltype(vecVertices)::value_type)
        ...
        // Finally a surface extractor will probably output additional data. This is highly
        // application dependant. For this example code we're just uploading it as a set of
        // bytes which we can read individually, but real code will want to do something
        // specialised here.
        ...
        glVertexAttribIPointer(2, size, GL_UNSIGNED_BYTE,
                               sizeof(typename MeshType::VertexType),
