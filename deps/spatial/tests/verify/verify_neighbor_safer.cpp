...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_neighbor_decrement, Tp, int2_maps) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_neighbor_upper_bound, Tp, quad_sets) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_manhattan_neighbor, Tp, double6_maps) {
    Tp      fix(3, randomize(-2, 2));
    double6 target;
    same()(target, 0, 2);
    {
        // With default diff with float
        manhattan_neighbor_iterator<typename Tp::container_type, double> i,
    ...
    }
    {
        ...
        manhattan_neighbor_iterator<const typename Tp::container_type, double,
                                    double6_diff>
            i,
            j = manhattan_neighbor_cbegin(fix.container, double6_diff(),
                                          target),
    ...
    }
    {
        ...
        manhattan_neighbor_iterator_pair<typename Tp::container_type, double> i,
    ...
    }
    {
        ...
        manhattan_neighbor_iterator_pair<const typename Tp::container_type,
                                         double, double6_diff>
            i, j = manhattan_neighbor_crange(fix.container, double6_diff(),
                                             target);
        i = j;
        BOOST_CHECK(i == j);
        BOOST_CHECK_EQUAL(distance(i.first), distance(j.first));
