...
// cities given a map. The example is taken from the book AI: A Modern Approach,
// 3rd Ed., by Russel, where a map
// of Romania is given. The target node is Bucharest, and the user can specify
// the initial city from which the
